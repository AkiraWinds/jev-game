...
| [`experiment/red-herring`](https://github.com/AkiraWinds/jev-game/commit/f53b9be) | `f53b9be` | **v2, 3-judge** (`JUDGE_SLM_MODEL=gpt-5.4-nano-2026-03-17`, `JUDGE_LLM_MODEL=gpt-5.4-2026-03-05`) | **100%** | **403 ms** | **100%** | **700 ms** | **100%** | **857 ms** |
